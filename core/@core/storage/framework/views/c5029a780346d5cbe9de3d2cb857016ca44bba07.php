                                        ...
                                        <ul class="img-meta" style="display: none">
                                            ...
                                            <li class="imgalt">
                                                <div class="img-alt-wrap">
                                                    <input type="text" name="img_alt_tag" placeholder="<?php echo e(__('Image Alt Text')); ?>">
...
</div><?php /**PATH /home/hbarmqwo/rexoit.com/@core/resources/views/backend/partials/media-upload/media-upload-markup.blade.php ENDPATH**/ ?>