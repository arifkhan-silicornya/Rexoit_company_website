      ...
      <div class="row pt-5 mb-5 mx-auto">
        <div class="col-md-5 offset-md-2 mr-5">
          ...
          <?php echo csrf_field(); ?>
                ...
                <!--    <div class="tab">-->
                <!--      <h4 class="text-center text-success"><?php echo e($_REQUEST['msg']); ?></h4>-->
                <!--    </div>-->
                <!--<?php endif; ?>-->
...
</div><?php /**PATH /home/hbarmqwo/rexoit.com/@core/resources/views/frontend/rfp/form.blade.php ENDPATH**/ ?>