                                    ...
                                    <table class="table table-default" id="all_blog_table">
                                        ...
                                        <?php $__currentLoopData = $blog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                   <?php echo e(get_blog_category_by_id($data->id)); ?>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-primary btn-xs mb-3 mr-1" href="<?php echo e(route('admin.blog.edit',$data->id)); ?>">
                                                        <i class="ti-pencil"></i>
                                                    </a>
                                                    <a class="btn btn-lg btn-light btn-xs mb-3 mr-1" target="_blank" href="<?php echo e(route('frontend.blog.single', $data->slug)); ?>">
                                                        <i class="ti-eye"></i>
                                                    </a>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hbarmqwo/rexoit.com/@core/resources/views/backend/pages/blog/index.blade.php ENDPATH**/ ?>