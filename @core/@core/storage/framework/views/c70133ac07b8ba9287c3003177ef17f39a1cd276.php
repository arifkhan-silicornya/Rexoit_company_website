            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="breadcrumbs-area clearfix">
                        ...
                        <ul class="btn sbg1 pull-right text-light d-none">
                            <li> <h5> <a href="<?php echo e(route('backend.chat_user.chatPanel')); ?>" class="text-light">Clients Messages </a> </h5> </li>
                        </ul>
                    </div>
                </div>
...
<?php if(!empty(get_static_option('disable_admin_panel_sticky_menu'))): ?>
<script>
    (function($){
        "use strict";
...
<?php /**PATH /home/hbarmqwo/rexoit.com/@core/resources/views/backend/admin-master.blade.php ENDPATH**/ ?>