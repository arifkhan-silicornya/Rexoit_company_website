...
use App\Language;
use App\PaymentGateway\GlobalCurrency;
...
function load_google_fonts()
{
    ...
    $load_heading_font_variant = !empty($heading_font_variant_selected_arr) ? implode(',', $heading_font_variant_selected_arr) : 'regular';
