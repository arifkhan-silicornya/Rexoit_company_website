    ...
    <div class="mail-container">
        ...
        <table>
           <thead>
            ...
            <tbody>
            @php $cart_items = unserialize($data->cart_items,['class' => false]); @endphp
                    ...
                    <td>
                        <div class="product-info-wrap">
                            ...
                            @if(get_static_option('product_tax_type') == 'individual' && is_tax_enable())
                                ...
                                @endphp
                            <span class="pdetails" style="color: red"><strong>{{__('Tax')}} {{__('('.$percentage.'%) :')}}</strong> +{{amount_with_currency_symbol($tax_amount)}}</span>
                            @endif
