                                        ...
                                        <table class="table table-default" id="all_blog_table">
                                            ...
                                            <?php $__currentLoopData = $event; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><del><?php echo e(site_currency_symbol().$data->regular_price); ?></del> <span><?php echo e(site_currency_symbol().$data->sale_price); ?></span></td>
                                                    <td><?php echo e(get_product_category_by_id($data->category_id)); ?></td>
                                                    <td>
                                                        <?php if($data->stock_status == 'in_stock'): ?>
                                                            <span class="alert alert-success" ><?php echo e(__('In Stock')); ?></span>
                                                        <?php else: ?>
                                                            <span class="alert alert-danger"><?php echo e(__('Out Of Stock')); ?></span>
                                                        <?php endif; ?>
                                                    ...
                                                    <td>
                                                        <a tabindex="0" class="btn btn-danger btn-xs mb-3 mr-1"
                                                           ...
                                                           title=""
                                                           data-content="
                                                       <h6><?php echo e(__('Are you sure to delete this product?')); ?></h6>
                                                       <form method='post' action='<?php echo e(route('admin.products.delete',$data->id)); ?>'>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hbarmqwo/rexoit.com/@core/resources/views/backend/products/all-products.blade.php ENDPATH**/ ?>