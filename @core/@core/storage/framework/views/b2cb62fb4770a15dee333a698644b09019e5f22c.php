                        ...
                        <form action="<?php echo e(route('admin.page.update',$page_post->id)); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        <label for="meta_title"><?php echo e(__('Page Meta Title')); ?></label>
                                        <input type="text" name="meta_title"  class="form-control" value="<?php echo e($page_post->meta_title); ?>">
                                    </div>
                                    <div class="form-group">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hbarmqwo/rexoit.com/@core/resources/views/backend/pages/page/edit.blade.php ENDPATH**/ ?>