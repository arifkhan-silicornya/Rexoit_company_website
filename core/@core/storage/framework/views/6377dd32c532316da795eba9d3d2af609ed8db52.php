                        ...
                        <?php $__currentLoopData = $all_jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-12">
                                <div class="single-job-list-item">
                                    ...
                                    <a href="<?php echo e(route('frontend.jobs.single',$data->title)); ?>"><h3 class="title"><?php echo e($data->title); ?></h3></a>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hbarmqwo/rexoit.com/@core/resources/views/frontend/pages/jobs/jobs-search.blade.php ENDPATH**/ ?>