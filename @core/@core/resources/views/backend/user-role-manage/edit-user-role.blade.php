                        ...
                        <form action="{{route('admin.user.role.update.permission')}}" method="post"
                            ...
                            @php
                                $header_variant = get_static_option('home_page_variant');
                                  ...
                                  'sitemap_settings' => 'admin.general.sitemap.settings', 'rss_feed_settings' => 'admin.general.rss.feed.settings', 'licence_settings' => 'admin.general.license.settings', 'media_image_manage' => 'admin.upload.media.images.page'
                                  ];
                            @endphp
                            <div class="row">
