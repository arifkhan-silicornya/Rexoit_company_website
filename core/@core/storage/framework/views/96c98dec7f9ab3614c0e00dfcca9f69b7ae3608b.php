                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a tabindex="0" class="btn btn-danger btn-xs mb-3 mr-1"
                                                           ...
                                                           title=""
                                                           data-content="
                                                       <h6><?php echo e(__('Are you sure to delete this event?')); ?></h6>
                                                       <form method='post' action='<?php echo e(route('admin.events.delete',$data->id)); ?>'>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hbarmqwo/rexoit.com/@core/resources/views/backend/events/all-events.blade.php ENDPATH**/ ?>