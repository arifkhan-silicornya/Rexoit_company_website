...
{
    public function rfp_get()
    {
        return view('frontend.rfp.index');
    }
    
    public function rfp_post(Request $request)
    {
        $randomNumber = time()+random_int(1000000, 9999999);
        ...
        $data['duration'] = $request->project_duration;
        $data['company_about'] = $request->about_client_company;
        $data['project_summery'] = $request->project_executive_summary;
        $data['domain'] = $request->domain;
        $data['hosting'] = $request->hosting;
        $data['more_features'] = $request->more_features;
        $data['demolink'] = $request->demolink;
        $data['company_name'] = $request->companyName;
        $data['contact_person_name'] = $request->ContactPersonName;
        $data['contact_person_email'] = $request->ContactPersonEmail;
        $data['phone_number'] = $request->phoneNumber;
        $data['address'] = $request->ContactPersonAddress;
        
        
        if($request->file('fileforRFP') != "")
        {
            $image = $request->file('fileforRFP');
            $name = time().'.'.$image->getClientOriginalExtension();
            $uploads_dir = "assets/uploads/RFPFiles/";
        ...
        $data['session_id'] = $randomNumber;
        
        DB::table('rfp_client_project_proposal')->insert($data);
        
        
        $applicationType=array();
        
        $applicationType['client_web'] = $request->webClient;
        $applicationType['client_android'] = $request->androidClient;
        $applicationType['client_iOS'] = $request->iosClient;
        $applicationType['client_desktop'] = $request->desktopClient;
        
        $applicationType['admin_web'] = $request->webAdmin;
        $applicationType['admin_android'] = $request->androidAdmin;
        $applicationType['admin_iOS'] = $request->iosAdmin;
        $applicationType['admin_desktop'] = $request->desktopAdmin;
        
        $applicationType['vendor_web'] = $request->webVendor;
        $applicationType['vendor_android'] = $request->androidVendor;
        $applicationType['vendor_iOS'] = $request->iosVendor;
        $applicationType['vendor_desktop'] = $request->desktopVendor;
        $applicationType['session_id'] = $randomNumber;
        
        DB::table('rfp_target_application')->insert($applicationType);
        
        
        $humanLang=array();
        
        $humanLang['eng_lang'] = $request->englishLang;
        $humanLang['bang_lang'] = $request->banglaLang;
        $humanLang['hindi_lang'] = $request->hindiLang;
        $humanLang['other_lang'] = $request->otherHUmanLanguage;
        $humanLang['session_id'] = $randomNumber;;
        
        
        DB::table('rfp_target_language')->insert($humanLang);
        
        
        $features=array();
        
        $features['reg_login'] = $request->reg_login;
        $features['email_verification'] = $request->emailVerification;
        $features['phone_verification'] = $request->phoneVerification;
        $features['thirdPartyLogin'] = $request->thirdPartyLogin;
        $features['searchOption'] = $request->searchOption;
        $features['addTocart'] = $request->addTocart;
        
        $features['liveChat'] = $request->liveChat;
        $features['msngrchat'] = $request->msngrchat;
        $features['Whatsappchat'] = $request->Whatsappchat;
        $features['manualchat'] = $request->manualchat;
        
        
        $features['paymentSystem'] = $request->paymentSystem;
        $features['mob_banking'] = $request->mob_banking;
        $features['visa'] = $request->visa;
        $features['mastercard'] = $request->mastercard;
        $features['paypal_payoneer'] = $request->paypal_payoneer;
            
        $features['liveOrderTrack'] = $request->liveOrderTrack;
        $features['session_id'] = $randomNumber;
        
        DB::table('rfp_target_features')->insert($features);
         
            
        $tech=array();
        
        $tech['javascript'] = $request->html;
        $tech['bootstrap'] = $request->bootstrap;
        $tech['Reactjs'] = $request->Reactjs;
        $tech['nodejs'] = $request->nodejs;
        $tech['expressjs'] = $request->expressjs;
        $tech['java'] = $request->java;
        $tech['python'] = $request->python;
        $tech['django'] = $request->django;
        $tech['flask'] = $request->flask;
        $tech['swift'] = $request->swift;
        $tech['flutter'] = $request->flutter;
        $tech['othersTechnologies'] = $request->othersTechnologies;
        $tech['session_id'] = $randomNumber;
        
        
        DB::table('rfp_programming_langiage')->insert($tech);        
        
        
        // return redirect()->back()->with(['msg' => $success_message, 'type' => 'success']);
        return view('frontend.rfp.index')->with(['msg' => 'Your proposal send succesfully', 'type' => 'success']);
    }
    ...
    public function index()
    {
        ...
        $all_key_features = KeyFeatures::where('lang', $lang)->get();
		 ...
		 $all_service = Services::find( [61,60,59,55,52,51,50,48,46,45]);
         //$all_service = Services::find( [45,46,47,48,49,50,51,52,53]);
		 //$all_service = Services::find( [44,43,42,41,40,39,38,37,36]);
        ...
        $all_team_members = TeamMember::where('lang', $lang)->orderBy('id', 'desc')->take(get_static_option('home_page_09_team_member_area_items'))->take(14)->get();
    ...
    public function about_page()
    {
        ...
        $all_counterup = Counterup::where('lang', $lang)->get();
        $all_brand_logo = Brand::all();
        $all_team_members = TeamMember::where('lang', $lang)->orderBy('id', 'desc')->take(14)->get();
        ...
        $all_service = Services::where(['lang' => $lang, 'status' => 'publish'])->orderBy('id', 'desc')->take(5)->get();
