...
<?php $__env->startSection('breadcrumb'); ?>
    <li> <?php echo e(get_static_option('feedback_page_'.$user_select_lang_slug.'_name')); ?></li>
<?php $__env->stopSection(); ?>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="contact-info">
                        ...
                        <form action="<?php echo e(route('frontend.clients.feedback.store')); ?>" method="post" class="feedback-page-form" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hbarmqwo/rexoit.com/@core/resources/views/frontend/pages/feedback-page.blade.php ENDPATH**/ ?>