                    ...
                    <div class="info-bar-inner">
                        ...
                        <div class="right-content">
                            <div class="request-quote">
                                ...
                                <a style="top:0!important;border-radius:0px;" href="{{$quote_btn_url}}" class="py-2 rq-btn bg-blue-dark text-light mt-0">{{get_static_option('top_bar_'.get_user_lang().'_button_text')}} <i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
