...
<div class='ChatApp text-dark border-0'>
    <div  class='bg-white w-100 chatBox hide border-0' id='ChatApp' style="display:none;">
            ...
            @endphp
                ...
                @endphp
                        <div class='sender d-flex mb-2 '>
                          ...
                          <div style="background:#152b2c;" class='sender_chat_box text-white p-2 '>{{$row->admin_msg}}</div>
                        </div>
                @php
                    }
                ...
                @endphp
                        <div class='receiver d-flex mb-2  justify-content-end mr-1'>
                          <div class='receiver_chat_box text-white p-3 ' style="background:#11486A;">{{$row->user_msg}} </div>
      ...
      <!--{/* footer */}-->
      <form class='inputDiv w-100 d-flex bg-white border-0' action={{route('frontend.chat.message.user')}} method="post"> 
        @csrf
    ...
    <div id="chat_btn" onClick="chatAppBox();" class='d-none round_cor position-fixed chatIcon bg-transparent border-0'> <img src="{{asset('assets/frontend/img/chatapp/chat-icon-cryptocornya.png')}}" alt="chat app icon" width="60" /> </div>
</div>
