...
Route::middleware(['setlang:frontend','globalVariable','maintains_mode'])->group(function (){
    ...
    Route::get('/rfp','FrontendController@rfp_get');
    Route::post('/rfp','FrontendController@rfp_post');
    ...
    Route::post('/user-chat-msg','FrontendFormController@send_chat_message_user')->name('frontend.chat.message.user');


    //static page
    $user_lang  = get_user_lang();
    $quote_page_slug = !empty(get_static_option('quote_page_slug')) ? get_static_option('quote_page_slug') : 'query';
    ...
    Route::group(['middleware' => ['module_permission:gigs']],function (){
        ...
        Route::post('/gig-stripe','GigOrderController@stripe_charge')->name('frontend.gig.stripe.ipn');
        Route::get('/gig-stripe/pay','GigOrderController@stripe_ipn')->name('frontend.gig.stripe.success');
...
Route::get('/chat_user_panel/','messagePanel@show_panel')->name('backend.chat_user.chatPanel');
// Route::get('/chat_user_panel/{id}','FrontendController@plan_order')->name('frontend.plan.order');
