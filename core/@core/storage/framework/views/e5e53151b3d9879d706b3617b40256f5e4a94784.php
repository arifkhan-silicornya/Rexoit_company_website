            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="left-content-area">
                        ...
                        <!--                <p class="text-justify"><?php echo e($data->excerpt); ?></p>-->
                        <!--            </div>-->
                        <!--        </div>-->
                        <!--    </div>-->
                ...
                <div class="col-md-6 mt-3">
                    <div class="single-work-item-02">
                        ...
                        <div class="content">
                            ...
                            <p class="text-justify"><?php echo e($data->description); ?></p>
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hbarmqwo/rexoit.com/@core/resources/views/frontend/pages/about.blade.php ENDPATH**/ ?>