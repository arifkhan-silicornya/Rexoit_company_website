                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.scripts.settings')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="site_disqus_key"  cols="30" class="form-control" rows="5"><?php echo e(get_static_option('site_disqus_key')); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="tawk_api_key"><?php echo e(__('Tawk.to API')); ?></label>
                                <textarea name="tawk_api_key"  cols="30" class="form-control" rows="5"><?php echo e(get_static_option('tawk_api_key')); ?></textarea>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hbarmqwo/rexoit.com/@core/resources/views/backend/general-settings/thid-party.blade.php ENDPATH**/ ?>