...
$heading_font_variant = '';
    ...
    $heading_font_family .= sprintf('<option value="%1$s" %2$s>%3$s</option>',$font_family,$heading_font_family_selected,$font_family);
        ...
        if ($select_heading_fonts == $font_family){
            ...
            $heading_font_variant_select = !empty($heading_font_variant_selected_arr) && in_array($variant,$heading_font_variant_selected_arr) ? 'selected' : '';
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hbarmqwo/rexoit.com/@core/resources/views/backend/general-settings/typograhpy.blade.php ENDPATH**/ ?>