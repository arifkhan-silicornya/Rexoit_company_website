                        ...
                        @foreach($all_key_features as $data)
                            ...
                            @if($g <= 2)
                                <div class="icon-box-one margin-bottom-30 white" >
                                    <div class="icon">
                                        <i class="text-light {{$data->icon}}"></i>
                                    </div>
                                    <div class="content">
    ...
    <section class="our-cover-area section-bg-1 padding-top-110 padding-bottom-90">
        <div class="container">
            ...
            <div class="row">
                ...
                @endforeach
                    <div class="col-lg-2 ">
                        <a style="background-color:#152c4d;" href="{{url('/service')}}" class="btn text-light rounded-md btn-lg w-100 ">See More</a>
                    </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-7">
                    <div class="left-content-area">
                        <div class="aboutus-content-block margin-bottom-25">
                            <p class="text-justify">{{get_static_option('about_page_'.$user_select_lang_slug.'_about_section_description')}}</p>
                        </div>
                    </div>
                    <div class="col-md-3 ml-0 pl-0 mb-2">
                        <a style="background-color:#152c4d;"  href="{{url('/about')}}" class="w-100 btn btn-lg text-light rounded-lg">See More</a>
                    </div>
                </div>
                <div class="col-lg-5">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="singler-counterup-item-01 white">
                    <div class="icon">
                        <i style="color:#eee;" class="{{$data->icon}}" aria-hidden="true"></i>
                    </div>
                    <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 px-5 py-4 bg-custom-bluish">
                    <h4 class="text-left text-center">Contact Form</h4>
                        ...
                        @endif
                    <form method="post" action="{{route('frontend.quote.message')}}" enctype="multipart/form-data">
                        @csrf
                    ...
                    @foreach($all_team_members as $data)
                        ...
                        <div class="single-team-member-one">
                            <div class="thumb thumb2">
                                <span class="rounded-full rounded-circle">{!! render_image_markup_by_attachment_id($data->image,'','grid') !!}</span> 
                                <div class="hover">
                                    @php
                                        $social_fields = array(
                    ...
                    @foreach($all_blog as $data)
                        <div class="single-blog-grid-01 lates_news" >
                            <div class="thumb rounded-circle " >
                                <a href="{{route('frontend.blog.single',$data->slug)}}">{!! render_image_markup_by_attachment_id($data->image,'','grid') !!}</a>
                            </div>
                            <div class="content" style="height:350px;">
                                <h4 class="title"><a href="{{route('frontend.blog.single',$data->slug)}}">{{$data->title}}</a></h4>
                                <ul class="post-meta">
                                    <li><i class="fa fa-calendar"></i> {{date_format($data->created_at,'d M y')}}</li>
                                    <li><i class="fa fa-user"></i> {{render_blog_author($data->author)}}</li>
                                    <li>
